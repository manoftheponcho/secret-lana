...
class SceneBattle:
    def __init__(self, engine, formation):
        ...
        self.cursor = pyglet.sprite.Sprite(pyglet.image.load('./resources/cursor.png'))
        self.cursor.x, self.cursor.y = 96, 64
        ...
        pyglet.clock.schedule_once(self.engine.push_handlers, 3, (), on_draw=self.draw_menu)
    ...
    def on_key_press(self, symbol, modifiers):
        self.engine.push_handlers(on_draw=self.draw_menu)
